...
export default function IssueLinkCode() {
  ...
  return (
    <div className="fixed inset-0 min-h-screen flex items-center justify-center" style={{ background: BG }}>
      <div
        className="w-full max-w-2xl bg-white rounded-2xl p-8 shadow-lg text-center"
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 justify-center mt-2">
            <button
              ...
              aria-label="Back to resident list"
            >
              Back
            </button>
